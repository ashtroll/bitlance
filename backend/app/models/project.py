...
class Project(Base):
    ...
    project_type: Mapped[ProjectType] = mapped_column(SAEnum(ProjectType, name="project_type", create_type=False), nullable=False)
    status: Mapped[ProjectStatus] = mapped_column(SAEnum(ProjectStatus, name="project_status", create_type=False), default=ProjectStatus.draft)
    ...
    ai_roadmap: Mapped[dict] = mapped_column(JSONB, nullable=True)
    ...
    escrow = relationship("EscrowAccount", back_populates="project", uselist=False, cascade="all, delete-orphan")
